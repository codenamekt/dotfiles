# ~/.zsh/bindings.zsh — keybindings & vi-mode config
...
zvm_after_init() {
  # Tab -> trigger completion menu (with arrow-key navigation).
  zvm_bindkey viins '^I' expand-or-complete

  # Right arrow -> accept the displayed zsh-autosuggestions suggestion.
